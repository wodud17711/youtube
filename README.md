...
- react 설치 명령어. `npx create-react-app 타이틀`
...
- git add . 내 프로젝트에서 어떤 파일을 저장할지 선택
- git status . 내 프로젝트에서 어떤 파일이 저장되는지 터미널을 통해 육안으로 다시 확인하는 명령어
- git commit -m "메세지" 실제로 저장될 파일을 내 컴퓨터에 저장하는 명령어
- git push -u origin main 로컬에 저장된 파일을 깃허브에 올리는 명령어